...
<head>
  ...
  <title>الرابطة الولائية لكرة القدم الشلف</title>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .btn-1 {
      ...
      color: white;
      box-shadow: 0 4px 20px rgba(0,98,51,0.5);
    ...
    .btn-3 {
      background: linear-gradient(135deg, #D21034, #a50d26);
      color: white;
    ...
    .btn-4 .btn-icon-wrap { background: rgba(0,0,0,0.15); }
    .btn-4 .arrow-icon { color: rgba(10,31,15,0.6); }
...
<body>
  ...
  <nav class="navbar">
    ...
    <ul class="nav-links">
      <li><a href="index.php" class="active"><i class="fa-solid fa-house"></i> الرئيسية</a></li>
  ...
  <div class="container">
    ...
    <h1>الرابطة الولائية لكرة القدم الشلف</h1>
    <p class="subtitle">البوابة الرسمية</p>
    <div class="divider"></div>

    <div class="buttons-grid">

      <a href="https://www.lfwchlef.com/" target="_blank" class="btn btn-1" onclick="createRipple(event)">
        <span class="btn-left">
          <span class="btn-icon-wrap"><i class="fa-solid fa-globe"></i></span>
          <span>نحو الموقع الرسمي</span>
        </span>
        <i class="fa-solid fa-arrow-left arrow-icon"></i>
      </a>

      <a href="https://www.facebook.com/LWFChlef" target="_blank" class="btn btn-2" onclick="createRipple(event)">
        <span class="btn-left">
          <span class="btn-icon-wrap"><i class="fa-brands fa-facebook-f"></i></span>
          <span>نحو صفحة فيسبوك</span>
        </span>
        <i class="fa-solid fa-arrow-left arrow-icon"></i>
      </a>

      <a href="https://www.fafconnect.dz/login.php" target="_blank" class="btn btn-3" onclick="createRipple(event)">
        <span class="btn-left">
          <span class="btn-icon-wrap"><i class="fa-solid fa-link"></i></span>
          <span>نحو FAF Connect</span>
        </span>
        <i class="fa-solid fa-arrow-left arrow-icon"></i>
      </a>

      <a href="https://ems.fafconnect.dz/login" class="btn btn-4" onclick="createRipple(event)">
        <span class="btn-left">
          <span class="btn-icon-wrap"><i class="fa-solid fa-file-lines"></i></span>
          <span>نحو الورقة الإلكترونية</span>
        </span>
        <i class="fa-solid fa-arrow-left arrow-icon"></i>
      </a>
